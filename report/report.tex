...
\endminipage
\end{figure}
\label{fig:probability-accuracies}

The cross entropies are shown in figure~\ref{fig:probability-accuracies} where there does not seem to be any anomalies with respect to the corresponding accuracies.
